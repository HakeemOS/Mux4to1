...
HD_PWD='C:/Users/squid/OneDrive/Documents/Vivado/2022/Mux4to1/Mux4to1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux4to1_s.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mux4to1_s.tcl -notrace
