...
HD_PWD='C:/Users/squid/OneDrive/Documents/Vivado/2022/Mux4to1/Mux4to1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux4to1_s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mux4to1_s.tcl
